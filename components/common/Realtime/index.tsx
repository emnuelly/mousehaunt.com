...
const Realtime: NextPage = () => (
  <>
    <Container>
      <Left>
        <Phone>
          <Image src={rats} width='512px' height='287px' alt='Rats' placeholder='blur' />
        </Phone>
        <Hero>
      ...
      <Right>
        ...
        <Subtitle>
          Showcase your unique NFTs and your kickass skills in our action packed online multiplayer.
          <br />
          The better you are, the more rewards you get! Invite your friends and get rewards!
        </Subtitle>
        <Link
