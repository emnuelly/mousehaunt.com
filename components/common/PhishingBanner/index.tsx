  ...
  if (isOpen) {
    return (
      <Container>
        <ImageStack>
          <FirstImage>
            <Image src={image3} width='95px' height='120px' alt='Logo' placeholder='blur' />
          </FirstImage>
          <SecondImage>
            <Image src={image1} width='120px' height='120px' alt='Logo' placeholder='blur' />
          </SecondImage>

          <ThirdImage>
            <Image src={image2} width='120px' height='130px' alt='Logo' placeholder='blur' />
          </ThirdImage>
        </ImageStack>
          ...
          <div>
            <div>
              ...
              <PhishingParagraph>
                ...
                <Link href='https://mousehaunt.com'>https://mousehaunt.com</Link> - check the URL
                carefully.
              </PhishingParagraph>
            </div>
          </div>
