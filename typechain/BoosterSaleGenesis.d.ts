...
interface BoosterSaleGenesisInterface extends ethers.utils.Interface {
  functions: {
    'DEFAULT_ADMIN_ROLE()': FunctionFragment
    'OPERATOR_ROLE()': FunctionFragment
    'boosterOwner()': FunctionFragment
    'buy(uint256)': FunctionFragment
    'genesisBooster()': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'genesisBooster', values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: 'genesisBooster', data: BytesLike): Result
...
export class BoosterSaleGenesis extends BaseContract {
  ...
  interface: BoosterSaleGenesisInterface
  ...
  functions: {
    ...
    genesisBooster(overrides?: CallOverrides): Promise<[string]>
  ...
  callStatic: {
    ...
    buy(_numberOfBoosters: BigNumberish, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    genesisBooster(overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    genesisBooster(overrides?: CallOverrides): Promise<PopulatedTransaction>
