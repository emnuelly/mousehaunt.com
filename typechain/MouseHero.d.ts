...
interface MouseHeroInterface extends ethers.utils.Interface {
  functions: {
...
export class MouseHero extends BaseContract {
  ...
  callStatic: {
    ...
    safeMint(to: string, rarity: BigNumberish, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    ...
    'Mint(address,uint256,uint8)'(
      ...
      [string, BigNumber, number],
      { to: string; tokenId: BigNumber; rarity: number }
    >
