...
interface BoosterSaleInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'legendaryBooster', values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: 'legendaryBooster', data: BytesLike): Result
